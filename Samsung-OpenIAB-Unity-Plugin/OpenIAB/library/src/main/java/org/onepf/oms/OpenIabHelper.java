...
public class OpenIabHelper {
    ...
    //Activity used when project is in Unity. This will bridge UnityNativeActivity to Android Activity
    ...
    public OpenIabHelper(@NotNull Context context, Options options) {
		...
		Logger.i("Samsung OpenIAB Version: " + OPENIAB_SAMSUNG_VER);
        checkOptions();
    }
...
//        }
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, @NotNull String sku, int requestCode,
                                               IabHelper.OnIabPurchaseFinishedListener listener, String extraData) {
		Logger.d("Purchase flow for SUBS Item started");
    ...
    Inventory queryInventory(final boolean querySkuDetails,
                             @Nullable final List<String> moreSkus, Object... extraParams)
            throws IabException {
        return queryInventory(querySkuDetails, moreSkus, null, extraParams);
    }
    ...
    public Inventory queryInventory(final boolean querySkuDetails,
                                    ...
                                    @Nullable final List<String> moreSubsSkus, Object... extraParams)
            throws IabException {
        if (Utils.uiThread()) {
        ...
        return appStoreBillingService.queryInventory(querySkuDetails, moreItemStoreSkus, moreSubsStoreSkus, extraParams);
    }

    /**
     * @see #queryInventoryAsync(boolean, List, List, IabHelper.QueryInventoryFinishedListener, Object...)
	 * Added extraParams parameter to match interface
	 * @param extraParams this allows additional parameters if needed. Function will still work with legacy code.
     */
    public void queryInventoryAsync(@NotNull final IabHelper.QueryInventoryFinishedListener listener, Object... extraParams) {
        queryInventoryAsync(true, listener, extraParams);
    }
    ...
    public void queryInventoryAsync(final boolean querySkuDetails,
                                    @NotNull IabHelper.QueryInventoryFinishedListener listener, Object... extraParams) {
	...
	//TODO
    public List<SkuDetails> querySkuList() throws IabException{
        return querySkuList("10");
    }
	...
	public List<SkuDetails> querySkuList(String skuType) throws IabException{
        ...
        return appStoreBillingService.querySkuList(skuType);
	}
		...
		new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    result = new IabResult(BILLING_RESPONSE_RESULT_OK, "Sku List refresh successful.");
                } catch (IabException exception) {
                    result = exception.getResult();
