...
public interface AppstoreInAppBillingService {
     ...
     */
    @Nullable
    Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus, List<String> moreSubsSkus, Object... extraParams) throws IabException;

	List<SkuDetails> querySkuList(String skuTypes) throws IabException;
