...
public class FortumoBillingService implements AppstoreInAppBillingService {
	 ...
	 **/
    @Override
    public Inventory queryInventory(boolean querySkuDetails, @Nullable List<String> moreItemSkus, List<String> moreSubsSkus, Object... extraParams) throws IabException {
